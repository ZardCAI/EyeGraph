...
from transformers import (AutoModel, GenerationConfig, LlamaForCausalLM,
                          LlamaTokenizer, Qwen2ForCausalLM, MistralForCausalLM)
...
class InternVLChatModel(PreTrainedModel):
    ...
    def __init__(self, config: InternVLChatConfig, vision_model=None, language_model=None, tokenizer=None):
    ...
    def forward(
        ...
        loss = None
        mask = (labels != -100)
        filtered_tensor = [sample[mask[i]] for i, sample in enumerate(labels)]
